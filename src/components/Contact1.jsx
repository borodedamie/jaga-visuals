...
const Contact1 = () => {
  ...
  return (
    <div className="flex mx-5 md:mx-0 pt-[2rem] md:pt-0 pb-[5rem] md:pb-0 flex-col lg:flex-row justify-center items-center gap-[2rem] lg:gap-[5rem] xl:gap-[10rem] h-fit lg:h-[90vh]">
