    ...
    <div className="flex pt-[3rem] md:pt-0 flex-col md:flex-row justify-center items-center md:items-start gap-[2rem] md:gap-[10rem]">
      ...
      <div className="flex flex-col">
        ...
        <form className="flex flex-col ">
          ...
          <input className="border-b-2 font-medium mb-5 border-[#5b5959] leading-10" placeholder="Email"></input>
          <input className="border-b-2 font-medium mb-5 border-[#5b5959] leading-10" placeholder="Upload File [pdf,jpeg,docx,ppt]"></input>
          <input className="border-2 font-medium mt-3 mb-5 border-[#5b5959] leading-10" type="text" placeholder="Message"></input>
          <div className="flex flex-row justify-end">
          <button type="submit" className="border-[2px] items-center cursor-pointer font-bold w-[10rem] h-[2.5rem] flex text-[14px] text-center justify-center rounded-[2rem] border-[blue]">
            SUBMIT
          </button>
          </div>
