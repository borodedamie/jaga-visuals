...
const Contact1 = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Email validation
    const isGmail = /\b@gmail\.com$/i.test(email);
  ...
  return (
    <div className="flex mx-5 md:mx-0 pt-[2rem] md:pt-0 pb-[5rem] md:pb-[4rem] flex-col lg:flex-row justify-center items items-center md:items-stretch md:px-[15vw] lg:items-center gap-[2rem] lg:gap-[5rem] xl:gap-[10rem] h-fit lg:h-[90vh]">
