...
const Interests = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${hero})` }} className="flex pt-[10rem] md:pt-[10rem] bg-cover h-[100vh] mt-20 flex-col px-5 md:px-0 md:flex-row py-[10rem] md:py-0 justify-center items-start md:items-start gap-[10%]">
