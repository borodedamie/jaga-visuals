...
const Interests = () => {
  return (
    <div className="flex mt-20 px-5 flex-col md:flex-row max-w-[100%] w-[100%] py-20 h-fit md:h-[40rem] justify-center items-center md:items-start gap-20 text-white text-[32px] font-bold bg-gradient-to-r from-purple-200 from-10% via-purple-300 via-30% to-purple-400 to-50%">
