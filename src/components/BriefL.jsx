...
const BriefL = () => {
  return (
    <div className="px-5 md:px-20 flex flex-col justify-between">
      <h2 className="font-bold text-[65px] text-[blue]">The Brief</h2>
      ...
      <div className="flex flex-col gap-5 md:gap-10 px-5 md:px-10 py-20 items-center">
        <div className="border rounded-2xl h-[20rem] w-full bg-[grey]"></div>
        <div className="border rounded-2xl h-[20rem] w-full bg-[grey]"></div>
        <div className="border rounded-2xl h-[20rem] w-full bg-[grey]"></div>
        <div className="border rounded-2xl h-[20rem] w-full bg-[grey]"></div>
        <div className="border rounded-2xl h-[20rem] w-full bg-[grey]"></div>
