...
const Footer = () => {
  return (
    <div className="py-10 px-[8rem] md:pb-0 md:pt-20 font-bold flex flex-col md:flex-row justify-between text-[white] h-fit md:h-[37rem] bg-[#1c1b1b]">
      <div className="flex flex-row gap-[10rem] justify-center">
        <div className="text-[18px] flex flex-col leading-[3rem]">
          ...
          <NavLink className="text-[white] hover:text-[#0dfff6]" to="/privacy_policy">
            Privacy Policy{" "}
          </NavLink>
        </div>
        <div className="text-[18px] leading-10">
          <h1 className="text-[#0dfff6] tracking-widest font-semibold">OFFICES</h1>
          <p className="text-[white] hover:text-[#0dfff6]" style={{ cursor: "pointer" }}>Nigeria</p>
          <p className="text-[white] hover:text-[#0dfff6]" style={{ cursor: "pointer" }}>Dubai</p>
        </div>
      </div>
      <div className="text-[18px] order-first md:order-last flex flex-col text-center md:text-right leading-10">
        ...
        <div className="gap-3 pb-3 md:pb-16 pt-5 flex flex-row justify-center md:justify-end">
          <div className="hover:border-[#0dfff6] rounded-full border flex h-[2.5rem] w-[2.5rem] items-center text-center justify-center" style={{ cursor: "pointer" }}>
          ...
          <div className="hover:border-[#0dfff6] rounded-full border flex flex h-[2.5rem] w-[2.5rem] items-center text-center justify-center" style={{ cursor: "pointer" }}>
        ...
        <p className="text-[14px] leading-10 pb-5">Sign up to our newsletter</p>
        <p className="text-[white] hover:text-[#0dfff6] text-[25px] lowercase md:normal-case" style={{ cursor: "pointer" }}>
